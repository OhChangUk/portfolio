...
function Skills({domRef}) {
  ...
  return (
    <>
        <div ref={domRef} className="w-full pb-24 pt-32 bg-orange-50 overflow-hidden">
                            ...
                            skill.map((e, i) => {
                                return (
                                    <SwiperSlide key={i} className="overflow-hidden relative">
                                        ...
                                        {selectedImage === i && (
                                            <div className='absolute top-0 left-1/2 transform -translate-x-1/2 bg-black text-white'>
                                            {e}
                                            </div>
                                        )}
